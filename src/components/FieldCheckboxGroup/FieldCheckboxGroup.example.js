...
const label = <h3>Fishing styles</h3>;
...
const optionalProps = {
  name: 'fishingStyles-optional',
  id: 'fishingStyles-optional',
  ...commonProps,
};

const requiredProps = {
  name: 'fishingStyles-required',
  id: `${formNameRequired}.fishingStyles-required`,
  ...commonProps,
