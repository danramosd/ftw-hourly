  ...
  return (
    <div className={classes}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to High Country Digital.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            <a
              href="https://localfishingguide.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://localfishingguide.com
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        users and/or third parties on the Service, you agree to use the Service at your own risk.
        You understand that by using the Service You may be exposed to content that You may find
      ...
      <p>
        ...
        our copyright agent via email at info@localfishingguide.com and include in Your notice a
      ...
      <p>
        You can contact our copyright agent via email at info@localfishingguide.com. Upon receipt of
