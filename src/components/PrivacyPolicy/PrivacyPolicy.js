    ...
    <div className={classes}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to High Country Digital, LLC
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Local Fishing GUide, accessible from{' '}
            <a
              href="https://www.localfishingguide.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.localfishingguide.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <p>
            The information gathered by Google Places is held in accordance with the Privacy Policy
            of Google:{' '}
            <a
      ...
      <p>
        ...
        in Our Privacy Policy and it applies solely to all visitors, users, and others who reside in
      ...
      <p>
        ...
        which we may collect or may have been collected from California residents within the last
        twelve (12) months.
      </p>
      <p>
        ...
        in fact collected by Us, but reflects our good faith belief to the best of our knowledge
        that some of that information from the applicable category may be and may have been
        collected. For example, certain categories of personal information would only be collected
      ...
      <ul>
        <li>
          ...
          Service, preferences You express or provide through our Service, or from Your purchases on
          our Service.
        </li>
        <li>
      ...
      <ul>
        <li>By email: info@localfishingguide.com</li>
      </ul>
      <p>
